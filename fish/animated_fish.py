...
class AnimatedFish(pygame.sprite.Sprite):
    ...
    def _update_animation(self):
        """frame_counter: counts how many game iterations
        has passed since the last frame change
        frame_delay: only when the counter reaches that delay does
        the code advance current_frame and update self.image """
